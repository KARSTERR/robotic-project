...
function displayOptimalPlants(temperature, humidity, light) {
  ...
  const plants = [
    { name: "Domates", temperature: [18, 25], humidity: [60, 70], light: [60, 80] },
    { name: "Marul", temperature: [15, 20], humidity: [50, 70], light: [40, 60] },
    { name: "Reyhan", temperature: [20, 30], humidity: [40, 60], light: [70, 90] },
    { name: "Salatalik", temperature: [22, 28], humidity: [50, 70], light: [60, 80] },
    { name: "Ispanak", temperature: [10, 20], humidity: [60, 80], light: [50, 70] }
  ];
  
  const trees = [
    { name: "Elma Ağacı", temperature: [15, 25], humidity: [50, 70], light: [50, 70] },
    { name: "Meşe Ağacı", temperature: [10, 20], humidity: [40, 60], light: [40, 60] },
    { name: "Mango Ağacı", temperature: [25, 35], humidity: [60, 80], light: [70, 90] },
    { name: "Muz Ağacı", temperature: [20, 30], humidity: [60, 80], light: [60, 80] },
    { name: "Limon Ağacı", temperature: [20, 30], humidity: [50, 70], light: [60, 80] }
  ];
